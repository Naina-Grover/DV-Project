...
server <- function(input, output, session){
    ...
    boxplot(ratings$allgenders_0age_avg_vote,ratings$allgenders_18age_avg_vote,ratings$allgenders_30age_avg_vote,
            ratings$allgenders_45age_avg_vote, vertical=TRUE, main="All genders average Votes",
            names = c("0Years","18Years","30years","45Years"),ylim=c(2,10),col ="light blue")
